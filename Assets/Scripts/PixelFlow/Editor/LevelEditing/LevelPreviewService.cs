...
{
    internal static class LevelPreviewService
    {
            ...
            out string error)
        {
            ...
            {
                error = "Could not find SceneContext in the open scene.";
                return false;
            }
            ...
            var blockPrefab = ResolveBlockPrefab(blockData, environment, fallbackBlockPrefab);
            if (blockPrefab == null)
            {
                error = "Assign a block prefab on the active block data or default block data before spawning preview.";
                return false;
            }
            ...
            {
                error = "Could not find Block_Container on the resolved EnvironmentContext.";
                return false;
            }
            ...
            var layout = BoardFitUtility.ResolveDisplayGridLayout(
                environment,
        ...
        public static void ClearPreview(GameSceneContext sceneContext, Theme theme)
        {
            ...
            var environment = sceneContext.EnvironmentInstance;
    ...
    internal static class BoardFitUtility
    {
